...
import static dev.kurama.chess.backend.auth.authority.Authority.UserAuthority.USER_CREATE;
import static dev.kurama.chess.backend.auth.authority.Authority.UserAuthority.USER_DELETE;
import static dev.kurama.chess.backend.auth.authority.Authority.UserAuthority.USER_READ;
import static dev.kurama.chess.backend.auth.authority.Authority.UserAuthority.USER_UPDATE;
