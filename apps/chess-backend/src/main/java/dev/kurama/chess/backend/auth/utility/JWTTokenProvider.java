...
import static dev.kurama.chess.backend.auth.constant.SecurityConstant.AUTHORITIES;
import static dev.kurama.chess.backend.auth.constant.SecurityConstant.AUTH_AUDIENCE;
import static dev.kurama.chess.backend.auth.constant.SecurityConstant.AUTH_ISSUER;
import static dev.kurama.chess.backend.auth.constant.SecurityConstant.EXPIRATION_TIME;
import static dev.kurama.chess.backend.auth.constant.SecurityConstant.TOKEN_CANNOT_BE_VERIFIED;
