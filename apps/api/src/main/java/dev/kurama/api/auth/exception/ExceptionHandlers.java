package dev.kurama.api.auth.exception;
...
import dev.kurama.api.auth.domain.DomainResponse;
import dev.kurama.api.auth.exception.domain.EmailExistsException;
import dev.kurama.api.auth.exception.domain.EmailNotFoundException;
