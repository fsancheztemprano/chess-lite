...
import dev.kurama.api.auth.api.domain.input.ChangeUserPasswordInput;
import dev.kurama.api.auth.api.domain.input.UpdateUserProfileInput;
import dev.kurama.api.auth.api.domain.input.UserInput;
import dev.kurama.api.auth.api.domain.model.UserModel;
import dev.kurama.api.auth.api.mapper.UserMapper;
import dev.kurama.api.auth.exception.domain.EmailExistsException;
import dev.kurama.api.auth.exception.domain.RoleNotFoundException;
import dev.kurama.api.auth.exception.domain.UserNotFoundException;
import dev.kurama.api.auth.exception.domain.UsernameExistsException;
import dev.kurama.api.auth.service.UserService;
