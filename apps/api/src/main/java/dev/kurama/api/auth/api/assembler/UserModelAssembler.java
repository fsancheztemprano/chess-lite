package dev.kurama.api.auth.api.assembler;

import static dev.kurama.api.auth.api.domain.relations.UserRelations.USERS_REL;
import static dev.kurama.api.auth.authority.UserAuthority.PROFILE_DELETE;
import static dev.kurama.api.auth.authority.UserAuthority.PROFILE_UPDATE;
import static dev.kurama.api.auth.authority.UserAuthority.USER_CREATE;
import static dev.kurama.api.auth.authority.UserAuthority.USER_DELETE;
import static dev.kurama.api.auth.authority.UserAuthority.USER_UPDATE;
