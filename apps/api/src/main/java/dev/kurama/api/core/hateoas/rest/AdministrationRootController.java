...
import static dev.kurama.api.core.api.domain.relations.AdministrationRelations.USER_MANAGEMENT_ROOT_REL;
import static dev.kurama.api.core.api.domain.relations.AuthorityRelations.AUTHORITIES_REL;
import static dev.kurama.api.core.api.domain.relations.RoleRelations.ROLES_REL;
import static dev.kurama.api.core.api.domain.relations.UserRelations.USERS_REL;
import static dev.kurama.api.core.api.domain.relations.UserRelations.USER_REL;
...
import static dev.kurama.api.core.hateoas.domain.HateoasRelations.ROOT_REL;
